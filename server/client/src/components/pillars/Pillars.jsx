...
import { faUserMd, faBookMedical, faHospital, faAmbulance, faFlask, faEllipsisH } from "@fortawesome/free-solid-svg-icons";
...
const EmergencyServiceItem = ({ icon, title, link }) => {
  return (
    <a href={link} className="flex-shrink-0 bg-white bg-opacity-75 rounded-lg p-4 mr-4 mb-4">
