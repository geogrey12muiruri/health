...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-600 shadow-lg font-sans text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex items-center rounded-xl overflow-hidden">
  {/* Left Section with SVG */}
  <div className="bg-yellow-400 p-2 flex items-center justify-center" style={{ width: '30%', height: '40px' }}>
