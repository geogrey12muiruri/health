...
const Navbar = () => {
  ...
  <div className="bg-yellow-400 p-2 flex items-center justify-center" style={{ width: '25%', height: '40px' }}>
  ...
  <div className="bg-blue-500 text-white p-2 font-bold flex items-center" style={{ width: '75%', minHeight: '40px' }}>
    Medplus<sup>+</sup>
  </div>
</Link>
