...
const Navbar = () => {
  ...
  <div className="bg-yellow-400 p-2 flex items-center justify-center" style={{ width: '40%', height: '50px' }}>
  ...
  <div className="bg-blue-500 text-white p-2 font-bold flex items-center" style={{ width: '60%', minHeight: '50px' }}>
    Medplus<sup>+</sup>
  </div>
</Link>
