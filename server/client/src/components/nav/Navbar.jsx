...
const Navbar = () => {
  ...
  <div className="bg-yellow-400 p-2 flex items-center justify-center" style={{ width: '35%', height: '40px' }}>
  ...
  <div className="bg-blue-500 text-white p-2 font-pacifico font-semi-bold flex items-center" style={{ width: '65%', minHeight: '40px' }}>
    Medplus<sup>+</sup>
  </div>
</Link>
          {/* Menu Icon */}
